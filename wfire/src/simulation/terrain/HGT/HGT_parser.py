...
from gmalthgtparser import HgtParser   
    ...
    parser.add_argument('-lat1', type=str, required=False, help="latitude1 for HGT file")
    parser.add_argument('-lon1', type=str, required=False, help="longitude1 for HGT file")
    parser.add_argument('-lat2', type=str, required=False, help="latitude2 for HGT file")
    parser.add_argument('-lon2', type=str, required=False, help="longitude2 for HGT file")
    args = parser.parse_args()

    os.chdir(args.wdir)
    # lat1 = args.lat1
    print('test ok', args.wdir)
